...
<!-- Mirrored from unicamp.thememove.com/main/faculty-staffs/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:36:31 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Faculty &#038; Staffs &#8211; Main</title>
    ...
    <style id='unicamp-style-inline-css'>
        ...
        .page-title-bar-bg {
            background-image: url(../../../unicamp-4437.kxcdn.com/main/wp-content/uploads/sites/2/2021/02/faculty-staffs-title-bar-bg.jpg) !important
        }
    ...
    <link rel='stylesheet' id='elementor-post-22-css'
        ...
        media='all' />
    <link rel='stylesheet' id='elementor-post-1220-css'
        href='../../../unicamp-4437.kxcdn.com/main/wp-content/uploads/sites/2/elementor/css/post-12209621.css?ver=1747747428'
        media='all' />
    ...
    <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/1220.json" />
...
.card .overlay {
  position: absolute;
  bottom: 0;
  background: linear-gradient(to top, rgba(35, 58, 89, 0.95), rgba(35, 58, 89, 0.4));
  color: white;
  width: 100%;
  padding: 25px 20px;
  text-align: center;
...
.card:hover .overlay {
  background: linear-gradient(to top, rgba(35, 58, 89, 1), rgba(35, 58, 89, 0.6));
}
...
.overlay span {
  ...
  margin-top: 15px;
  background: linear-gradient(90deg, #14b5d9 0%, #5b86e5 100%);
  color: #fff;
  padding: 6px 16px;
  border-radius: 25px;
  font-size: 0.85rem;
...
<body
    class="wp-singular page-template-default page page-id-1220 wp-embed-responsive wp-theme-unicamp wp-child-theme-unicamp-child-demo theme-unicamp tutor-lms woocommerce-no-js desktop desktop-menu mobile-menu-push-to-left header-sticky-both wide page-has-no-sidebar title-bar-02 title-bar-has-post-title woocommerce elementor-default elementor-kit-22 elementor-page elementor-page-1220"
            ...
            {{-- <div id="page-title-bar" class="page-title-bar page-title-bar-02">
                <div class="page-title-bar-inner">
                    ...
                    <div id="page-breadcrumb" class="page-breadcrumb">
                        <div class="container">
                            <ul class="insight_core_breadcrumb">
                                ...
                                <li class="level-2 sub item-current tail current"><span>Faculty & Staffs</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="page-title-bar-heading container">
                        ...
                        <h1 class="heading"> Faculty &#038; Staffs </h1>
                    ...
                    <div class="row">
                        ...
                        <div id="page-main-content" class="page-main-content">
                            ...
                            <div class="rich-snippet display-none">
                                <h1 class="entry-title">Faculty &#038; Staffs</h1> <span class="published">February
                                    26, 2021</span>
                                <span class="updated" data-time="2021-05-11 7:42">2021-05-11 7:42</span>
                            </div>

                            <article id="post-1220"
                                class="post-1220 page type-page status-publish hentry post-no-thumbnail">
                                <div data-elementor-type="wp-page" data-elementor-id="1220"
                                    class="elementor elementor-1220" data-elementor-post-type="page">
                                    <section
                                        class="elementor-section elementor-top-section elementor-element elementor-element-226be63 elementor-section-boxed elementor-section-gap-beside-yes elementor-section-height-default elementor-section-height-default elementor-section-content-align-center elementor-section-column-vertical-align-stretch"
                                        data-id="226be63" data-element_type="section">
                                        <div class="elementor-container elementor-column-gap-extended">
                                            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-f31bf24"
                                                data-id="f31bf24" data-element_type="column">
                                                <div class="elementor-widget-wrap elementor-element-populated">
                                                    <div class="elementor-element elementor-element-7605803 elementor-invisible elementor-widget elementor-widget-tm-heading"
                                                        data-id="7605803" data-element_type="widget"
                                                    ...
                                                    <section
                                                        class="elementor-section elementor-inner-section elementor-element elementor-element-fd37d00 elementor-section-gap-beside-no elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section-column-vertical-align-stretch"
                                                        data-id="fd37d00" data-element_type="section">
                                                        <div class="gallery">

  <!-- Annual Function -->
   
    @foreach ($galleryItems as $item)
        <div onclick="window.location.href='{{ url('gallery/'.$item->slug) }}'"  class="card">
...
{"prefetch":[{"source":"document","where":{"and":[{"href_matches":"\/main\/*"},{"not":{"href_matches":["\/main\/wp-*.php","\/main\/wp-admin\/*","\/main\/wp-content\/uploads\/sites\/2\/*","\/main\/wp-content\/*","\/main\/wp-content\/plugins\/*","\/main\/wp-content\/themes\/unicamp-child-demo\/*","\/main\/wp-content\/themes\/unicamp\/*","\/main\/*\\?(.+)"]}},{"not":{"selector_matches":"a[rel~=\"nofollow\"]"}},{"not":{"selector_matches":".no-prefetch, .no-prefetch a"}}]},"eagerness":"conservative"}]}
                ...
                <div class="woosc-popup-content-inner">
                    ...
                    Select the fields to be shown. Others will be hidden. Drag and drop to rearrange the order. <ul
                        ...
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="fw74" checked /><span class="move">Image</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="8jnw" checked /><span class="move">SKU</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="ttkv" checked /><span class="move">Rating</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="vnkc" checked /><span class="move">Price</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="e8ks" checked /><span class="move">Stock</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="o5aw" checked /><span class="move">Availability</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="xzwv" checked /><span class="move">Add to cart</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="22g4" checked /><span class="move">Description</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="y2vx" checked /><span class="move">Content</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="tbl8" checked /><span class="move">Weight</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="rz1d" checked /><span class="move">Dimensions</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="okyf" checked /><span class="move">Additional information</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script id="elementor-frontend-js-before">
        ...
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 1220,
                "title": "Faculty%20%26%20Staffs%20%E2%80%93%20Main",
                "excerpt": "",
                "featuredImage": false
            }
        };
...
<!-- Mirrored from unicamp.thememove.com/main/faculty-staffs/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:36:34 GMT -->
